...
full_initials = [name.split()[0][0] + name.split()[1][0] for name in  #(Bob, Martin) [0][1] sets first string and second value
                 full_names]
print(full_initials)
...
large_numbers = [large_num for large_num in integers if large_num > 9]
print(large_numbers)